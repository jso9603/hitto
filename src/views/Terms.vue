<template>
  <div class="terms">
    <div class="container">
      <h3>제 1조 (목적)</h3>
      <p>
        이 약관은 모희또(이하 "회사"라 합니다)가 제공하는 행운번호 생성
      ...
      <ol>
        <li>
          회사는 이용자에게 행운번호 생성 서비스와 관련된 다양한 콘텐츠를
          제공합니다.
        </li>
        <li>
      ...
      <h3>제 4조 (행운번호 생성 및 책임)</h3>
      <ol>
        <li>
          회사가 제공하는 행운번호 생성 서비스는 순전히 이용자의 재미와
        ...
        <li>
          이용자는 회사가 제공하는 행운번호 생성 서비스 결과에 대해 개인적인
          판단에 의한 책임을 부담합니다.
        </li>
      </ol>
